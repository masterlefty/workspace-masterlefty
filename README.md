...
our pubsubviewer widget that makes those links for us.</td></tr><tr valign="top"><td>loadWidgets</td><td>function</td><td>function (callback) </td></tr><tr valign="top"><td>loadTouchPlateWidget</td><td>function</td><td>function (callback) <br><br>Load the Touch Plate widget via chilipeppr.load()</td></tr>
      </tbody>
  </table>

...
our pubsubviewer widget that makes those links for us.</td></tr><tr valign="top"><td>load3dviewer</td><td>function</td><td>function (callback) <br><br>Load the 3D Viewer widget via chilipeppr.load()</td></tr>
      </tbody>
  </table>

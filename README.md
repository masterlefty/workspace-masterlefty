# com-chilipeppr-workspace-masterlefty
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-masterlefty"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / masterlefty"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace for development widgets-masterlefty."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/masterlefty/workspace-masterlefty/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/masterlefty/workspace-masterlefty"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/masterlefty/workspace-masterlefty"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-masterlefty-masterlefty.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
our pubsubviewer widget that makes those links for us.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>loadTouchplateWidget</td><td>function</td><td>function (callback) <br><br>Load the Touch Plate widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadPlaygroundWidget</td><td>function</td><td>function (callback) <br><br>Load the Playground widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadGcodeWidget</td><td>function</td><td>function (callback) <br><br>Load the Gcode widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>load3dViewer</td><td>function</td><td>function (callback) <br><br>Loading zone for the Center Column widgets
Load the widgets via chilipeppr.load()</td></tr><tr valign="top"><td>loadAxesWidget</td><td>function</td><td>function (callback) <br><br>Load the Axes widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadTinygWidget</td><td>function</td><td>function (callback) <br><br>Load the Tinyg widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr>
      </tbody>
  </table>
